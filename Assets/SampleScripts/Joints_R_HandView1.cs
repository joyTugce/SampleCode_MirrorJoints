...
{
    // this script moves the joints of the right hand model 

    public JointsModelBothHands myDataModel;
    public GameObject R_HandPivotOnWrist;


    private GameObject R_mainJntObj,
    ...
    void Start()
    {
        JointsModelBothHands.onPoseUpdate += UpdateRightHandModel;
    ...
    {
        handDistanceMultiplier = myDataModel._WristRot.x;

        R_HandPivotOnWrist.transform.position = myDataModel._WristPos + Vector3.forward * handDistanceMultiplier;
        R_HandPivotOnWrist.transform.rotation = myDataModel._WristRot; 
