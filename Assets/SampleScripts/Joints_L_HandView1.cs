...
{
    // this script moves the joints of the left hand model 

    public JointsModelBothHands myDataModel;
    public GameObject L_HandPivotOnWrist;

    private GameObject  L_mainJntObj,
    ...
    void Start()
    {
        JointsModelBothHands.onPoseUpdate += UpdateLeftHandModel;
    ...
    private void UpdateLeftHandModel()
    {
        ...
        L_HandPivotOnWrist.transform.rotation = myDataModel._WristRot; 
