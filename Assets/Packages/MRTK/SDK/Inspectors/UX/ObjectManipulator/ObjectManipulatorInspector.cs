...
namespace Microsoft.MixedReality.Toolkit.Editor
{
    ...
    public class ObjectManipulatorInspector : UnityEditor.Editor
    {
        ...
        private SerializedProperty onManipulationDenied;
        ...
        public void OnEnable()
        {
            ...
            onManipulationDenied = serializedObject.FindProperty("onManipulationDenied");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (eventsFoldout)
            {
                ...
                //EditorGUILayout.PropertyField(onManipulationDenied);
